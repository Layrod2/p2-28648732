...
router.use(cookieParser('layrod'));
router.use(session({
	secret: 'layrod',
	resave: true,
...
passport.use( new PassportLocal(function(username, password, done){
	...
	if(username === 'rossana@hotmail.com' && password === 'rossana123')
		return done(null,{id: 1, name: "Rossana"});
...
passport.deserializeUser(function(user, done){
	done(null,{id: 1, name: "Rossana"});
})


const db=path.join(__dirname,"basedato","basedato.db");
